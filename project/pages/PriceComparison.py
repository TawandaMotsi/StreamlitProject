...
if available_categories:
    category_options = ["All"] + available_categories  # Add an "All" option for no filter
    selected_category = st.selectbox("Select a category", category_options)  # Display category options
else:
...
if selected_date:
    ...
    # Add category filter to the query if a specific category is selected
