...
# Introduction
st.write("""
Welcome to Irish Supermarket Scraping, your go-to platform for up-to-date supermarket pricing insights. Explore the sections to uncover detailed analytics of the supermarket landscape.
""")

# Sidebar Navigation

# Define each view as a function
st.subheader("Welcome to Irish Supermarket Analyser!")
st.write("""
Navigate the Site:
